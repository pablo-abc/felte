...
- a7d1091: fix solid initialization from field `value` prop
...
- b007b7f: BREAKING: `data`, `errors`, `warnings` and `touched` are no longer stores but accessors
...
- b007b7f: Fix updater subscribing to whole store when calling
- b007b7f: Fix when publishing as modules
- b007b7f: Use Solid's observable function instead of our own
