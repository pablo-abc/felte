...
- c6f1497: Reuse single MutationObserver instance
- c6f1497: Fix missing disconnect on destroy
...
- b007b7f: Set appropriate store depending on level
- b007b7f: `onSubmitError` does nothing when `level !== 'error'`
