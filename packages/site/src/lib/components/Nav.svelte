  ...
  <nav>
    <h1>
      <a
        ...
        <picture>
          <source srcset="felte-logo-dark-mode.svg" media="(prefers-color-scheme: dark)">
    ...
    <ul>
      ...
      <li>
        <a
          ...
          >
          <svg height="25" width="25" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
